...
sealed class ProcGen
{
    ...
    new Tuple<int, string, int>(0, "Hand Gun Ammo", 35), new Tuple<int, string, int>(0, "Potion of Health", 35),
    new Tuple<int, string, int>(2, "Morphine", 25), new Tuple<int, string, int>(2, "Bandage", 40),
    ...
    new Tuple<int, string, int>(1, "Monster", 80),
    new Tuple<int, string, int>(3, "Abom", 15),
    new Tuple<int, string, int>(5, "Abom", 30),
    new Tuple<int, string, int>(7, "Abom", 60),
    };
